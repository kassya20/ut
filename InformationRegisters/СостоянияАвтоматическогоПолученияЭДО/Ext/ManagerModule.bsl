...
//  ПричинаОстановки - Строка
// 
// Возвращаемое значение:
//  См. НовоеСостояниеПолучения
Функция Записать(ИдентификаторЭДО, ЕстьОшибки, ДатаНачала, Остановлено = Неопределено, ПричинаОстановки = "") Экспорт
	...
	Если ЗаписьНабора.Остановлено И ЗначениеЗаполнено(ПричинаОстановки) Тогда
		ЗаписьНабора.ПричинаОстановки = ПричинаОстановки;
	КонецЕсли;
...
// Возвращаемое значение:
//  Массив из Строка
Функция ОстановленоПоИдентификаторамЭДО(ИдентификаторыЭДО = Неопределено) Экспорт
	...
	Запрос.Текст =
		...
		|	РегистрСведений.СостоянияАвтоматическогоПолученияЭДО КАК СостоянияАвтоматическогоПолученияЭДО
		|ГДЕ
		|	СостоянияАвтоматическогоПолученияЭДО.Остановлено
		|	И &УсловиеПоИдентификаторамЭДО";
