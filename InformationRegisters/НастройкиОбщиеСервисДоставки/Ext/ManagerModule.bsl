...
// Если настройка сервиса перевозчика отсутствует, то для каждого указанного параметра возвращается значение "Неопределено".
// Если в настройке отсутствует указанный параметр, то для него возвращается значение "Неопределено".
// 
// Параметры:
