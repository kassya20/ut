...
Процедура РассчитатьПоСтатистикеЗавершение(Настройки, ДополнительныеПараметры) Экспорт 
	...
	Если Настройки <> Неопределено Тогда
		...
		ОповещениеОЗавершении = Новый ОписаниеОповещения("РассчитатьПоСтатистикеОповещение", ЭтотОбъект);
...
&НаКлиенте
Процедура РассчитатьПоСтатистикеОповещение(Результат, ДополнительныеПараметры) Экспорт
	...
	КоличествоСтрок = ПолучитьРезультатРасчетаНаСервере(Результат.АдресРезультата);
...
&НаСервере
Функция ПолучитьРезультатРасчетаНаСервере(АдресХранилища)
