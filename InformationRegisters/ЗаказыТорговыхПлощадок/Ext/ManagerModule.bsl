...
Функция ПроверитьЗаказы(Заказы, РезультатПроверкиЗаказов = Неопределено,
	...
	Пока ВыборкаОтправленийИзмененных.Следующий() Цикл
		...
		Если Не ПустаяСтрока(ВыборкаОтправленийИзмененных.НомерОтправления) Тогда
...
Функция ДанныеДляПроверкиЗаказов(Заказы, ЗаполнитьСведенияОбЭкземплярах)
	...
	ТекстЗапроса =
		...
		|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ СведенияПоТоварамСДокументамиОтгрузки КАК ПриоритетныеДокументыОтгрузки
		...
		|ИЗ
		|	СведенияПоТоварамСДокументамиОтгрузки КАК СведенияПоТоварам
		|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ СведенияПоТоварамСДокументамиОтгрузки КАК ПриоритетныеНомераОтправлений
		...
		|		ЛЕВОЕ СОЕДИНЕНИЕ СведенияПоТоварамСДокументамиОтгрузки КАК ПриоритетныеДокументыОтгрузки
		|		ПО СведенияПоТоварам.Заказ = ПриоритетныеДокументыОтгрузки.Заказ
		|			И СведенияПоТоварам.НомерОтправления = ПриоритетныеДокументыОтгрузки.НомерОтправления
