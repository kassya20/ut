...
Процедура ЗаполнитьДанные()
	...
	ИспользоватьЦентрЭДО       = ДанныеПриглашения.ИспользоватьЦентрЭДО;
...
Процедура ОтправкаПриглашенияОповещениеОЗавершении(Результат, ДополнительныеПараметры) Экспорт
	...
	Элементы.ГруппаСтраницы.ТекущаяСтраница = Элементы.СтраницаОсновная;
	Элементы.ОтправитьПовторно.Доступность = Истина;
...
Процедура МК_НастроитьЭлементыФормы()
	...
	Элементы.Переместить(Элементы.ОтправитьПовторно, Элементы.МК_ГруппаКоманд);
	Элементы.Переместить(Элементы.Принять, Элементы.МК_ГруппаКоманд);
	Элементы.Переместить(Элементы.Отклонить, Элементы.МК_ГруппаКоманд);
	Элементы.Переместить(Элементы.Отозвать, Элементы.МК_ГруппаКоманд);
	
	Элементы.КомандыФормы.Видимость = Ложь;

	ИнтерфейсМобильногоЭДОКлиентСервер.ОформитьАкцентнуюКнопку(МК_ЭлементыСтиля, Элементы.Принять);
	ИнтерфейсМобильногоЭДОКлиентСервер.ОформитьАкцентнуюКнопку(МК_ЭлементыСтиля, Элементы.ОтправитьПовторно);
	ИнтерфейсМобильногоЭДОКлиентСервер.ОформитьАкцентнуюКнопку(МК_ЭлементыСтиля, Элементы.Отклонить, Ложь);
	ИнтерфейсМобильногоЭДОКлиентСервер.ОформитьАкцентнуюКнопку(МК_ЭлементыСтиля, Элементы.Отозвать, Ложь);
	
	Элементы.СтраницаОсновная.ЦветФона = ЦветФона;
	Элементы.СтраницаОжидание.ЦветФона = ЦветФона;
	Элементы.СтраницаВыполнено.ЦветФона = ЦветФона;
	Элементы.СтраницаБуферОбмена.ЦветФона = ЦветФона;
	Элементы.МК_ГруппаКоманд.ЦветФона = ЦветФона;
	Элементы.ГруппаСтатусБар.ЦветФона = ЦветФона;
	
	Элементы.СтраницаТребуетсяОтправить.ЦветФона = ЦветФона;
	Элементы.СтраницаПринято.ЦветФона = ЦветФона;
	Элементы.СтраницаОтклонено.ЦветФона = ЦветФона;
	Элементы.СтраницаОжидаемСогласия.ЦветФона = ЦветФона;
	Элементы.СтраницаТребуетсяСогласие.ЦветФона = ЦветФона;
	Элементы.СтраницаНастройкаРоуминга.ЦветФона = ЦветФона;
	Элементы.СтраницаОшибка.ЦветФона = ЦветФона;
	Элементы.СтраницаНеТребуется.ЦветФона = ЦветФона;
