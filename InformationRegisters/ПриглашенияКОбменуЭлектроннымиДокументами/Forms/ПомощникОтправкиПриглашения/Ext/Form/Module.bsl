...
&НаКлиенте
Процедура НадписьИностранныйКонтрагентНажатие(Элемент)
	ОткрытьФорму("РегистрСведений.ПриглашенияКОбменуЭлектроннымиДокументами.Форма.ПриглашениеИностранногоКонтрагента");
КонецПроцедуры
...
Функция НачатьПолучениеДанныхДляНастройкиОтправкиПриглашения()
	...
	ПараметрыДанных = ПриглашенияЭДО.НовыеПараметрыДанныхЗаполненияНастройкиОтправкиПриглашений();
	...
	Если ЗначениеЗаполнено(Организация)
		...
		ПараметрыПолученияСвязиИдентификаторов = ПриглашенияЭДО.НовыеПараметрыПолученияСвязиИдентификаторов();
	...
	Возврат ДлительныеОперации.ВыполнитьФункцию(ПараметрыВыполнения,
		"ПриглашенияЭДО.ДанныеЗаполненияНастройкиОтправкиПриглашений", ПараметрыДанных);
...
Процедура ЗаполнитьДанныеКонтрагентаПоПараметрамОтправки(ПараметрыОтправки)
	...
	Если ЗначениеЗаполнено(ПараметрыОтправки.ТипИнформацииОКонтрагенте) Тогда
...
Процедура ЗаполнитьДанныеКонтрагентаПоУмолчанию()
	...
	РеквизитыКонтрагента = ИнтеграцияЭДО.КлючевыеРеквизитыКонтрагента(Контрагент);
	КонтрагентИНН = РеквизитыКонтрагента.ИНН;
	КонтрагентКПП = РеквизитыКонтрагента.КПП;
	ЭтоИностранныйКонтрагент = ИнтеграцияЭДО.ТипУчастникаЭДО(Контрагент).ЭтоИностранноеЛицо
		И НЕ ЗначениеЗаполнено(СтрЗаменить(КонтрагентИНН, "0", ""));
...
Процедура НастроитьОсновнуюСтраницуФормы(Форма)
	...
	Элементы.НадписьИностранныйКонтрагент.Видимость = ЗначениеЗаполнено(Форма.Контрагент)
		И Форма.ЭтоИностранныйКонтрагент;
	Элементы.НадписьНеУказанИНН.Видимость = ЗначениеЗаполнено(Форма.Контрагент)
		И НЕ Форма.ЭтоИностранныйКонтрагент
		И ПустаяСтрока(Форма.КонтрагентИНН);
...
Процедура ОбновитьНастройкуОтправкиПриглашения(Форма, ПараметрыОтправки = Неопределено)
	...
	Форма.ИспользоватьЦентрЭДО = ПараметрыОтправки.ИспользоватьЦентрЭДО;
	...
	Если ВозможенАвтовыборИдентификатораКонтрагента(Форма, ПараметрыОтправки) Тогда
...
&НаКлиентеНаСервереБезКонтекста
Функция ВозможенАвтовыборИдентификатораКонтрагента(Форма, ПараметрыОтправки)
...
Функция НовыеПараметрыОтправкиПриглашения(ТипИнформацииОКонтрагенте, ПараметрыСвязиИдентификаторов = Неопределено)
	...
	ПараметрыОтправки.Вставить("ИспользоватьЦентрЭДО", Ложь);
...
Процедура ОтправитьПриглашениеПослеОтветаНаВопросОСоглашенииНаРоуминг()
	...
	Если Не ЗначениеЗаполнено(ПараметрыОпределенияТипаПриглашения.ТипИнформацииОКонтрагенте) Тогда
		
		Если ЗначениеЗаполнено(ИдентификаторКонтрагента) Тогда
			ПараметрыОпределенияТипаПриглашения.ТипИнформацииОКонтрагенте = ТипыИнформацииОКонтрагенте().ИдентификаторЭДО;
		ИначеЕсли ЗначениеЗаполнено(ЭлектроннаяПочта) Тогда
			ПараметрыОпределенияТипаПриглашения.ТипИнформацииОКонтрагенте = ТипыИнформацииОКонтрагенте().ЭлектроннаяПочта;
		ИначеЕсли ЗначениеЗаполнено(ОператорКонтрагента) Тогда
			ПараметрыОпределенияТипаПриглашения.ТипИнформацииОКонтрагенте  = ТипыИнформацииОКонтрагенте().ОператорЭДО;
		КонецЕсли;
