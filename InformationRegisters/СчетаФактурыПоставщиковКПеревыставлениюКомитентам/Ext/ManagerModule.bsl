...
Процедура ОбновитьСостояние(МассивДокументовОснований, ОтменяемыйДокумент = Неопределено) Экспорт
	...
	|	СчетФактураВыданный.Ссылка.СчетФактураОснование КАК СчетФактураОснование
	...
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Документ.СчетФактураВыданный КАК ДокументСчетФактураВыданный
	|		ПО СчетФактураВыданный.Ссылка = ДокументСчетФактураВыданный.Ссылка
	|			И ДокументСчетФактураВыданный.Проведен
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	...
	|				И (СчетФактураВыданныйИсходныйТовары.Ссылка = СчетФактураВыданныйТовары.ПредыдущийСчетФактура
	|					ИЛИ СчетФактураВыданныйИсходныйТовары.Ссылка = ДанныеСФВыданных.СчетФактураОснование)
	|				И СчетФактураВыданныйИсходныйТовары.Ссылка.Проведен
	|	ГДЕ
	|		СчетФактураВыданныйТовары.Ссылка.Проведен
	|		И НЕ СчетФактураВыданныйТовары.Ссылка = &СсылкаСФ
	|СГРУППИРОВАТЬ ПО
	|		СчетФактураВыданныйИсходныйТовары.Ссылка,
