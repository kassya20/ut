...
//  * ИмяФайла - Строка
//  * РазмерФайла - Число
//  * НастройкиПредставления - См. НовыеНастройкиДоступностиНастроекПредставления
Функция НовыеСвойстваВизуализации() Экспорт
	Свойства = Новый Структура;
	Свойства.Вставить("ПредставлениеДокумента", "");
	...
	Свойства.Вставить("НастройкиПредставления", НовыеНастройкиДоступностиНастроекПредставления());
	Возврат Свойства;
КонецФункции
...
Функция НовыеНастройкиДоступностиНастроекПредставления()
...
Процедура Записать(ЭлектронныйДокумент, СвойстваВизуализации) Экспорт
	...
	ЗаписьНабора.Данные = Новый ХранилищеЗначения(СвойстваВизуализации.ПредставлениеДокумента, Новый СжатиеДанных(9));
...
Функция ВыборкаДокументовСИзмененнойВизуализацией(ВерсииДанныхДокументов)
	...
	Запрос.Текст =
		...
		|ИЗ
		|	ВерсииДанныхДокументов КАК ВерсииДанныхДокументов
		|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ РегистрСведений.ВизуализацииДокументовЦентраЭДО КАК ВизуализацииДокументовЦентраЭДО
		|		ПО ВерсииДанныхДокументов.ЭлектронныйДокумент = ВизуализацииДокументовЦентраЭДО.ЭлектронныйДокумент
		|		И ВерсииДанныхДокументов.ВерсияДанных <> ВизуализацииДокументовЦентраЭДО.ВерсияДанных";
