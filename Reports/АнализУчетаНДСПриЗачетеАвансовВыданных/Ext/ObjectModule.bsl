...
Функция ПолучитьВнешниеНаборыДанных()
	...
	Запрос.УстановитьПараметр("ТипСсылки", ОбщегоНазначения.ИдентификаторОбъектаМетаданных("Документ.СчетФактураПолученныйАванс"));
	...
	|			И РеестрДокументов.СторнируемыйДокумент = СчетФактура.Ссылка
