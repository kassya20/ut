...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
	...
	|	ВЫБОР
	|		КОГДА ТаблицаТоваров.АналитикаУчетаНоменклатуры <> ЗНАЧЕНИЕ(Справочник.КлючиАналитикиУчетаНоменклатуры.ПустаяСсылка)
	|			ТОГДА ТаблицаТоваров.АналитикаУчетаНоменклатуры
	|		ИНАЧЕ ЕСТЬNULL(Аналитика.КлючАналитики, ЗНАЧЕНИЕ(Справочник.КлючиАналитикиУчетаНоменклатуры.ПустаяСсылка))
	...
	|	ВЫБОР
	|		КОГДА НЕ ДоступныеВидыЗапасовДляОрганизаций.ВидЗапасов ЕСТЬ NULL
	|			ТОГДА ВЫБОР
	|					КОГДА (Ключи.Номенклатура.ПрослеживаемыйТовар
	|								ИЛИ (Ключи.Номенклатура.ВестиУчетПоГТД
	|									И &ЗапретитьОперацииСТоварамиБезНомеровГТД))
	...
	|						ТОГДА 0
	|					ИНАЧЕ ВЫБОР
	|							КОГДА ДоступныеВидыЗапасовДляОрганизаций.ВидЗапасов.Организация = ТаблицаТоваров.Организация
	...
	|	ВЫБОР
	|		КОГДА НЕ ДоступныеВидыЗапасовДляОрганизаций.ВидЗапасов ЕСТЬ NULL
	|				И НЕ ТаблицаТоваров.Назначение ЕСТЬ NULL
	|			ТОГДА ВЫБОР
	|					КОГДА (Ключи.Номенклатура.ПрослеживаемыйТовар
	|								ИЛИ (Ключи.Номенклатура.ВестиУчетПоГТД
	|									И &ЗапретитьОперацииСТоварамиБезНомеровГТД))
