...
//    	* ДоговорЭквайринга - СправочникСсылка.ДоговорыЭквайринга - Договор эквайринга
//    	* Организация - СправочникСсылка.Организации - Организация
//    	* Эквайер - СправочникСсылка.Контрагенты - Эквайер
//    	* Валюта - СправочникСсылка.Валюты - Валюта
//    	* РазрешитьПлатежиБезУказанияЗаявок - Булево - Признак допустимости возвратов без оформления заявок на
...
Функция ПолучитьРеквизитыЭквайринговогоТерминала(ЭквайринговыйТерминал) Экспорт
	...
	СтруктураРеквизитов.Вставить("ДоговорЭквайринга", Справочники.ДоговорыЭквайринга.ПустаяСсылка());
...
Функция ПараметрыЭквайринговыхТерминаловПоОрганизации(Организация, РабочееМесто, ИспользоватьПодключаемоеОборудование) Экспорт
	...
	|	ЭквайринговыеТерминалы.ПодключаемоеОборудованиеККТ КАК ПодключаемоеОборудованиеККТ
	|ИЗ
	...
	Пока Выборка.Следующий() Цикл
		...
		ЭквайринговыйТерминал.Вставить("ПодключаемоеОборудованиеККТ",            Выборка.ПодключаемоеОборудованиеККТ);
...
// 
// Параметры:
//  ПодключаемоеОборудованиеККТ - СправочникСсылка.ПодключаемоеОборудование - Ссылка на подключение к ККТ
// 
// Возвращаемое значение:
...
Функция ПодключаемоеОборудованиеЭквайринговогоТерминалаДляСверкиИтогов(ПодключаемоеОборудованиеККТ) Экспорт 
	...
	ПодключенныеТерминалы = Новый Массив;
	Пока ВыборкаЗапроса.Следующий() Цикл
		ПодключенныеТерминалы.Добавить(ВыборкаЗапроса.ПодключаемоеОборудование);
	КонецЦикла;
	
	Возврат ПодключенныеТерминалы;
