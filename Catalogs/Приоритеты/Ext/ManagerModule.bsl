...
// Функция для сравнения приоритетов
//
// Параметры:
//  Приоритет1	 - СправочникСсылка.Приоритеты - Первое значение сравнения.
//  Приоритет2	 - СправочникСсылка.Приоритеты - Второе значение сравнения.
// 
// Возвращаемое значение:
...
//
Функция СравнитьПриоритеты(Приоритет1, Приоритет2) Экспорт
	
	Массив = Новый Массив;
	Массив.Добавить(Приоритет1);
	Массив.Добавить(Приоритет2);
	Результат = ОбщегоНазначения.ЗначениеРеквизитаОбъектов(
		Массив,
		"РеквизитДопУпорядочивания");
	Возврат Результат[Приоритет2] - Результат[Приоритет1];
