...
Процедура ИспользоватьГрафикПредприятияПриИзменении(Элемент)
	...
	ИспользоватьГрафикПриИзмененииНаСервере();
...
Процедура ИспользоватьСменыПриИзменении(Элемент)
	...
	ИспользоватьСменыПриИзмененииНаСервере()
...
&НаСервере
Процедура ИспользоватьГрафикПриИзмененииНаСервере()
...
&НаСервере
Процедура ИспользоватьСменыПриИзмененииНаСервере()
