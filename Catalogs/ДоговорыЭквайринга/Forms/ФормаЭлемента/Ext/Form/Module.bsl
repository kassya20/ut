...
Процедура ЗаполнитьСписокСпособовРасчета()
	...
	СписокСпособовРасчета = Элементы.СпособПроведенияПлатежа.СписокВыбора;
	СписокСпособовРасчета.Очистить();
	
	СписокСпособовРасчета.Добавить(Перечисления.СпособыПроведенияПлатежей.ИнтернетЭквайринг);
	СписокСпособовРасчета.Добавить(Перечисления.СпособыПроведенияПлатежей.ЭквайринговыйТерминал);
	
	Если Не СтандартныеПодсистемыСервер.ЭтоБазоваяВерсияКонфигурации() Тогда
		СписокСпособовРасчета.Добавить(Перечисления.СпособыПроведенияПлатежей.СистемаБыстрыхПлатежей);
	КонецЕсли;
