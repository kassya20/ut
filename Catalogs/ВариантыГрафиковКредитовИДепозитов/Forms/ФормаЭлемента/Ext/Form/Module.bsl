...
Процедура ЗаписатьНаборГрафика(ТипГрафика, Ссылка)
	...
	РесурсыНабора = Набор.Метаданные().Ресурсы;
	Для Каждого РесурсНабора Из РесурсыНабора Цикл
		МассивРесурсов.Добавить(РесурсНабора.Имя);
	КонецЦикла;
	
	ДанныеНабора = Набор.Выгрузить();
	ДанныеНабора.Свернуть("Период,ВариантГрафика", СтрСоединить(МассивРесурсов, ","));
