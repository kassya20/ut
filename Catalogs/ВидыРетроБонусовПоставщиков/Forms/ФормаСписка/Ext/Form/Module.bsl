...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЕстьПравоИзменения = ПравоДоступа("Изменение", Метаданные.Справочники.ВидыРетроБонусовПоставщиков);
...
Функция УстановитьСтатусСервер(Знач ВидыРетроБонусов, Знач НовыйСтатус)
	...
	Возврат Справочники.ВидыРетроБонусовПоставщиков.УстановитьСтатус(
		ВидыРетроБонусов,
		НовыйСтатус);
...
//  Массив из СправочникСсылка.ВидыРетроБонусовПоставщиков
//
&НаКлиенте
Функция ВыделенныеВидыКСменеСтатуса()
	
	ВидыКОбработке = Новый Массив; // Массив из СправочникСсылка.ВидыРетроБонусовПоставщиков
	...
	ВыделенныеВидыГруппы = Новый Массив; // Массив из СправочникСсылка.ВидыРетроБонусовПоставщиков
	Для Каждого ВидРетроБонуса Из Элементы.Список.ВыделенныеСтроки Цикл // СправочникСсылка.ВидыРетроБонусовПоставщиков
