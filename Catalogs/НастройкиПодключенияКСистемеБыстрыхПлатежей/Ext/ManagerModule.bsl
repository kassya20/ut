...
Процедура ДобавитьКомандыПечати(КомандыПечати) Экспорт
	...
	НастройкиПлатежныхСистемСобытия.ПриОпределенииТиповОбъектовПечати(ТипыОбъектовПечати);
	...
	Если ТипыОбъектовПечати.Количество() > 0 Тогда
...
//
Функция НастройкиПодключенияПоВарианту(ВариантНастройки) Экспорт
	...
	|	Справочник.НастройкиПодключенияКСистемеБыстрыхПлатежей КАК НастройкиПодключенияКСистемеБыстрыхПлатежей
	|ГДЕ
	|	НастройкиПодключенияКСистемеБыстрыхПлатежей.ВариантНастройки = &ВариантНастройки";
