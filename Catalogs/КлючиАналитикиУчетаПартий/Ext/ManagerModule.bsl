...
Функция ТекстЗапросаВтТаблицаАналитикУчетаПартий(ТекстВыборкаПоляАналитик, ЗапросОбщий, ТекстыЗапроса = Неопределено) Экспорт
	...
	КонецЕсли;
	Если ЗапросОбщий.Параметры.Свойство("УпрощеннаяСистемаНалогообложения") Тогда
		ЗапросАналитикиПартий.УстановитьПараметр("УпрощеннаяСистемаНалогообложения", ЗапросОбщий.Параметры.УпрощеннаяСистемаНалогообложения);
	КонецЕсли;
