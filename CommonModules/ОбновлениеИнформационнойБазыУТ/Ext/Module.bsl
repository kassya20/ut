...
#Область АктуализироватьВидыКонтактнойИнформации

	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "11.5.27.41";
	Обработчик.Процедура = "ОбновлениеИнформационнойБазыУТ.АктуализироватьВидыКонтактнойИнформации";
	Обработчик.РежимВыполнения = "Оперативно";
	Обработчик.Комментарий = НСтр("ru = 'Обновление свойств предопределенных элементов видов контактной информации для справочника ""Помещения и территории"".'");
...
Процедура АктуализироватьВидыКонтактнойИнформации() Экспорт
	...
	ПараметрыОбновления.Элементы.Добавить(УправлениеКонтактнойИнформацией.ВидКонтактнойИнформацииПоИмени("СправочникТерриторииИПомещения"));
	ПараметрыОбновления.Элементы.Добавить(УправлениеКонтактнойИнформацией.ВидКонтактнойИнформацииПоИмени("АдресТерриторииИПомещения"));
	ПараметрыОбновления.Элементы.Добавить(УправлениеКонтактнойИнформацией.ВидКонтактнойИнформацииПоИмени("ТелефонТерриторииИПомещения"));
	ПараметрыОбновления.Элементы.Добавить(УправлениеКонтактнойИнформацией.ВидКонтактнойИнформацииПоИмени("EMailТерриторииИПомещения"));
