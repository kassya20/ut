...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	...
	Методы.Вставить("ЗаполнениеКонтрагентовНаМониторингеСПАРКРиски", Истина);
	...
	Методы.Вставить("ОбновлениеИндексовСПАРКРиски", Истина);
	...
	Методы.Вставить("ПроверитьГотовностьСправкиСПАРКРиски", Истина);
