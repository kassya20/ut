...
Процедура ОбработатьОшибку(
	...
	Иначе
		...
		ИначеЕсли ОписаниеОшибки = "ЗапрещенДоступКИнтернетСервисам" Тогда
			ТекстПредупреждения  = НСтр("ru = 'Доступ к Интернет-сервисам в приложении запрещен администратором (""Интернет-поддержка и сервисы"" — ""Разрешить доступ к Интернет-сервисам"").'");
		Иначе
...
Процедура ОткрытьДосьеКонтрагента() Экспорт
