...
//          6 - дополнительные коды по письмам ФНС № СД-36-3/185@ от 16.01.2026, № СД-36-3/478@ от 27.01.2026, № СД-36-3/185@ от 16.01.2026.
...
// Эта функция служат для определения, какая ставка НДС должна быть подставлена в документы
// 
// Параметры:
...
// Эта функция служат для определения, какая ставка НДС должна быть подставлена в документ
// 
// Параметры:
//  Период - Дата - Период, на который нужно получить ставку.
// 
...
// 
// Возвращаемое значение:
//  ПеречислениеСсылка.СтавкиНДС - пониженная Ставка НДС
