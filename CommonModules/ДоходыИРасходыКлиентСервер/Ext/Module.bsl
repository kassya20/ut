...
// Дополняет структуру действий механизма ПакетнаяОбработкаТабличнойЧасти действием заполнения статьи и аналитики расходов по номенклатуре.
// 
// Параметры:
...
// Дополняет структуру действий механизма ПакетнаяОбработкаТабличнойЧасти действием очистки статьи и аналитики расходов при изменении номенклатуры.
// 
// Параметры:
// 	СтруктураДействий - Структура - Структура действий
// 	ФормаИлиПараметры - ФормаКлиентскогоПриложения, Структура, Массив - При вызове из формы передается форма объекта. Из формы получаются закэшированные параметры выбора статей и аналитик. 
...
// Дополняет структуру действий механизма ПакетнаяОбработкаТабличнойЧасти действием инициализации реквизитов после добавления строки.
// 
// Параметры:
// 	СтруктураДействий - Структура - Структура действий
// 	ФормаИлиПараметры - ФормаКлиентскогоПриложения, Структура, Массив - При вызове из формы передается форма объекта. Из формы получаются закэшированные параметры выбора статей и аналитик. 
...
// Инициализировать значение статьи и аналитик.
// 
// Параметры:
//  Данные - ДанныеФормыЭлементКоллекции, СтрокаТабличнойЧасти - Данные
//  Параметры - см. ДоходыИРасходыСервер.ПараметрыВыбораСтатьиИАналитики
//
...
// 
// Параметры:
//  ФормаОбъект - ФормаКлиентскогоПриложения - Форма объект
//  ПутьКДанным - Строка - 
//  ИдентификаторСтроки - Неопределено, Произвольный - Идентификатор строки
// 
// Возвращаемое значение:
//  Неопределено, ДанныеФормыЭлементКоллекции, ФормаКлиентскогоПриложения - Данные по пути
//
...
Функция ПолучитьАналитикуПоУмолчанию(РеквизитыСтатьи, Данные) Экспорт
	...
	Типы = РеквизитыСтатьи.ТипЗначения.Типы();

	Типы = ДоходыИРасходыВызовСервера.УдалитьИзМассиваТипыКУдалению(Типы);	
