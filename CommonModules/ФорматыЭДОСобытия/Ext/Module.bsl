...
Процедура ЗаполнитьДанные_ИзвещениеОПолучении(Данные, ДанныеДляФормирования, Отказ) Экспорт
	...
	Иначе
		...
		ЭтоИностранноеЛицо = ТипУчастникаЭДО.ЭтоИностранноеЛицо
			И НЕ ЗначениеЗаполнено(СтрЗаменить(ДанныеЮрФизЛица.ИНН, "0", ""));
		...
		Если ЭтоИностранноеЛицо Тогда
			...
			ПараметрыОбработкиОшибок = 
				ЭлектронноеВзаимодействиеКлиентСервер.НовыеПараметрыОбработкиОшибки(Абонент.Ссылка);
			...
			ЭлектронноеВзаимодействие.ЗаполнитьЗначениеРеквизитаВДереве(Данные,
				Путь + ".ИдСтат", "ЮЛ", ПараметрыОбработкиОшибок);
			ЭлектронноеВзаимодействие.ЗаполнитьЗначениеРеквизитаВДереве(Данные,
				Путь + ".СтрРег", ДанныеЮрФизЛица.КодСтраныНерезидента, ПараметрыОбработкиОшибок);
			ЭлектронноеВзаимодействие.ЗаполнитьЗначениеРеквизитаВДереве(Данные,
				Путь + ".Наим", ПолноеНаименование, ПараметрыОбработкиОшибок);
			ЭлектронноеВзаимодействие.ЗаполнитьЗначениеРеквизитаВДереве(Данные,
				Путь + ".КодНПРег", ДанныеЮрФизЛица.ИдентификаторЮридическогоЛица, ПараметрыОбработкиОшибок);
	...
	Иначе
		...
		Если ЭтоИностранноеЛицо Тогда
			...
			ЭлектронноеВзаимодействие.ЗаполнитьЗначениеРеквизитаВДереве(
				Данные, Путь + ".ИдСтат", "ИО", ПараметрыОбработкиОшибок);
			ЭлектронноеВзаимодействие.ЗаполнитьЗначениеРеквизитаВДереве(
				Данные, Путь + ".КодСтр", ДанныеЮрФизЛица.КодСтраныНерезидента, ПараметрыОбработкиОшибок);
			ЭлектронноеВзаимодействие.ЗаполнитьЗначениеРеквизитаВДереве(
				Данные, Путь + ".НаимСтран", НаименованиеСтраныНерезидента, ПараметрыОбработкиОшибок);
			ЭлектронноеВзаимодействие.ЗаполнитьЗначениеРеквизитаВДереве(
				Данные, Путь + ".Наим", ПолноеНаименование, ПараметрыОбработкиОшибок);
			ЭлектронноеВзаимодействие.ЗаполнитьЗначениеРеквизитаВДереве(
				Данные, Путь + ".Идентиф", ДанныеЮрФизЛица.ИдентификаторЮридическогоЛица, ПараметрыОбработкиОшибок);
