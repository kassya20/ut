...
// Заполняет данные по чеку для создания фискальной операции, если чек не был помещен в очередь.
//
// Параметры:
//  ПараметрыОперацииЧека - см. ОборудованиеЧекопечатающиеУстройстваКлиентСервер.ПараметрыОперацииФискализацииЧека - структура данных по чеку для заполнения.
//  ДокументОперации - ОпределяемыйТип.ОснованиеФискальнойОперацииБПО - документ для формирования данных по чеку.
//
Процедура ЗаполнитьДанныеФискализации(ПараметрыОперацииЧека, ДокументОперации) Экспорт
