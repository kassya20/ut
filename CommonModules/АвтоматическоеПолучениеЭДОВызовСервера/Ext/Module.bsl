...
Процедура Отключить(Знач ИдентификаторЭДО = Неопределено) Экспорт
	...
	Если ИдентификаторЭДО = Неопределено Тогда
		...
		АвтоматическоеПолучениеЭДО.УстановитьВключатьАвтоматически(Ложь);
...
// 
// Возвращаемое значение:
//  См. АвтоматическоеПолучениеЭДО.ПараметрыАвтоматическогоВключения
Функция ПараметрыАвтоматическогоВключения(Знач Сертификаты) Экспорт
	
	Возврат АвтоматическоеПолучениеЭДО.ПараметрыАвтоматическогоВключения(Сертификаты);
