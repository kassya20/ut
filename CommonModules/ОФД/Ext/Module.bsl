...
Функция ОборотыКассовойСмены(Касса, НомерСмены) Экспорт
	...
	Возврат ОФДСервис.ОборотыКассовойСмены(Касса, НомерСмены);
...
Функция ЧекиКассовойСмены(Касса, НомерСмены) Экспорт
	...
	Возврат ОФДСервис.ЧекиКассовойСмены(Касса, НомерСмены);
...
//          **** ФискальныйНомер - Число, Неопределено - Фискальный номер корректируемого документа
//            Неопределено - данные отсутствуют;
...
Функция ПродажиЗаПериод(Касса, НачалоПериода, КонецПериода) Экспорт
	...
	Возврат ОФДСервис.ПродажиЗаПериод(Касса, НачалоПериода, КонецПериода);
