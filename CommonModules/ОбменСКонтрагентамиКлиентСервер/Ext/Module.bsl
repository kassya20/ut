...
// Возвращает варианты интерфейса электронных документов БЭД.
// 
// Возвращаемое значение:
//  Структура:
//  * Расширенный - Строка 
...
Функция ВариантыИнтерфейсаДокументовЭДО() Экспорт
	Возврат ИнтерфейсДокументовЭДОКлиентСервер.ВариантыИнтерфейсаДокументовЭДО();
КонецФункции

// Возвращает варианты интерфейса приглашений БЭД.
// 
// Возвращаемое значение:
//  Структура:
//  * Расширенный - Строка 
//  * ЛегкийКлиентЭДО - Строка
Функция ВариантыИнтерфейсаПриглашенийЭДО() Экспорт
	ВариантыИнтерфейса = Новый Структура;
	ВариантыИнтерфейса.Вставить("Расширенный", "Расширенный");
	ВариантыИнтерфейса.Вставить("ЛегкийКлиентЭДО", "ЛегкийКлиентЭДО");
...
//  * ЮридическийАдрес - Строка - JSON или XML, соответствующее XDTO-пакету КонтактнаяИнформация.
//  * ЭлектроннаяПочта - Строка
Функция НовыйДанныеОрганизации() Экспорт
	...
	Данные.Вставить("ДатаОГРН", '00010101');
	Данные.Вставить("СвидетельствоДатаВыдачи", '00010101');
...
// Создает структуру с настройками подключаемых команд ЭДО.
//
// Возвращаемое значение:
//  Структура:
//    * СкрыватьПереходКТекущиеДелаЭДО - Булево - Скрывать команду "Текущие дела ЭДО"
//
Функция НовыйНастройкиПодключаемыхКомандЭДО() Экспорт
	
	Настройки = Новый Структура;
	Настройки.Вставить("СкрыватьПереходКТекущиеДелаЭДО", Ложь);
	
	Возврат Настройки;
	
КонецФункции

// Формирует структуру параметров для открытия формы текущих дел ЭДО.
//
// Возвращаемое значение:
//  Структура - параметры аналогичные методу ОткрытьФорму:
//   * Владелец - Произвольный - форма или элемент управления другой формы.
//   * Уникальность - Произвольный - ключ уникальности формы.
//   * Окно - ОкноКлиентскогоПриложения - Окно, в котором будет открыта форма.
//   * РежимОткрытияОкна - РежимОткрытияОкнаФормы - Режим открытия окна формы.
Функция ПараметрыОткрытияФормыТекущиеДелаЭДО() Экспорт
...
// Возвращает варианты интерфейса ЭДО.
// 
// Возвращаемое значение:
//  Структура:
//  * Расширенный - Строка 
//  * Легкий - Строка
Функция ВариантыИнтерфейсаЭДО() Экспорт
	
	ВариантыИнтерфейса = Новый Структура;
	ВариантыИнтерфейса.Вставить("Расширенный", "Расширенный");
	ВариантыИнтерфейса.Вставить("Легкий", "Легкий");
