...
Процедура ПриОпределенииДоступностиКомандСпискаНастроек(
	...
	Если КешПараметров.ДоступностьНастроек.Получить(НастройкиПлатежныхСистемКлиентСервер.ИмяПодсистемыСБП()) Тогда
		ДоступныеКоманды.Добавить("ОткрытьШаблоныНазначения");
	КонецЕсли;
	Если КешПараметров.ВидимостьКассовыхСсылок Тогда
