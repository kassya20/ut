...
// Устанавливает видимость элемента формы статуса ошибки ГИС НР
// 
// Параметры:
...
// Возвращает состояние переменной сеанса
//
// Возвращаемое значение:
//  Структура:
//    * Порт                  - Число
...
// 
// Параметры:
//  ОповещениеЗавершения - ОписаниеОповещения - работает со "старой" нотации асинхронности, см. возвращаемое значение
...
//                       - Неопределено - в этом случае должна вызываться через Ждать, иначе будет
//                       выполняться без ожидания
//  ВключитьИнформацию   - Булево - дополняет результат дополнительными данными о плагине
//
// Возвращаемое значение:
//  Структура :
//    * Порт                  - Число 
...
// 
// Параметры:
//  ОповещениеЗавершения        - ОписаниеОповещения - работает со "старой" нотации асинхронности, 
...
// Открывает форму с настройками для плагина видеофиксации ГИС НР
// 
// Параметры:
...
Процедура УведомитьПользователя(ПояснениеЗаголовок, ПояснениеСодержимое, ПараметрыЦикла)

	Заголовок = ПояснениеЗаголовок + " " + НСтр("ru = 'ГИС НР'");
