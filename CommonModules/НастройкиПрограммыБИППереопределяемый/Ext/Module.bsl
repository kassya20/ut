...
Процедура ПриСозданииФормыИнтернетПоддержкаИСервисы(Форма) Экспорт
	...
	Форма.Элементы.ГруппаПлатежныеСистемы.Видимость = Не ЭтоБазоваяВерсия;
	Форма.Элементы.ГруппаОнлайнЗаказы.Видимость = Не ЭтоБазоваяВерсия;
	Форма.Элементы.ГруппаОнлайнОплаты.Видимость = Не ЭтоБазоваяВерсия;
