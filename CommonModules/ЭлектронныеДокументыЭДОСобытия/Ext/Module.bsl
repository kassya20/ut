...
Процедура ПослеФормированияЭлектронногоДокумента(ЭлектронныйДокумент, КонтекстДиагностики) Экспорт
	...
	ВизуализацияЭДО.ПослеФормированияЭлектронногоДокумента(ЭлектронныйДокумент, КонтекстДиагностики);
КонецПроцедуры
...
Процедура ПослеУтвержденияЭлектронногоДокумента(ЭлектронныйДокумент, КонтекстДиагностики) Экспорт
	...
	ВизуализацияЭДО.ПослеУтвержденияЭлектронногоДокумента(ЭлектронныйДокумент, КонтекстДиагностики);
КонецПроцедуры
...
Процедура ПослеПодписанияЭлектронногоДокумента(ЭлектронныйДокумент, КонтекстДиагностики) Экспорт
	...
	ВизуализацияЭДО.ПослеПодписанияЭлектронногоДокумента(ЭлектронныйДокумент, КонтекстДиагностики);
КонецПроцедуры
...
Процедура ПослеПроверкиПодписиЭлектронногоДокумента(ЭлектронныйДокумент, КонтекстДиагностики) Экспорт
	ВизуализацияЭДО.ПослеПроверкиПодписиЭлектронногоДокумента(ЭлектронныйДокумент, КонтекстДиагностики);
КонецПроцедуры
...
Процедура ПослеЗавершенияОбменаЭлектроннымДокументом(ЭлектронныйДокумент, КонтекстДиагностики) Экспорт
	...
	ВизуализацияЭДО.ПослеЗавершенияОбменаЭлектроннымДокументом(ЭлектронныйДокумент, КонтекстДиагностики);
КонецПроцедуры
...
Процедура ПослеАннулированияЭлектронногоДокумента(ЭлектронныйДокумент, КонтекстДиагностики) Экспорт
	...
	ВизуализацияЭДО.ПослеАннулированияЭлектронногоДокумента(ЭлектронныйДокумент, КонтекстДиагностики);
КонецПроцедуры

// Событие возникает после отклонения электронного документа.
// Выполняется вне транзакции.
// 
// Параметры:
//  ЭлектронныйДокумент - ДокументСсылка.ЭлектронныйДокументВходящийЭДО
...
Процедура ПослеОтклоненияЭлектронногоДокумента(ЭлектронныйДокумент, КонтекстДиагностики) Экспорт
	ИнтеграцияЭДО.ПослеОтклоненияЭлектронногоДокумента(ЭлектронныйДокумент, КонтекстДиагностики);
КонецПроцедуры

// Событие возникает после принудительного закрытия электронного документа.
// Выполняется вне транзакции.
// 
// Параметры:
//  ЭлектронныйДокумент - ДокументСсылка.ЭлектронныйДокументВходящийЭДО
...
Процедура ПослеПринудительногоЗакрытияЭлектронногоДокумента(ЭлектронныйДокумент, КонтекстДиагностики) Экспорт
	ИнтеграцияЭДО.ПослеПринудительногоЗакрытияЭлектронногоДокумента(ЭлектронныйДокумент, КонтекстДиагностики);
КонецПроцедуры

// Событие возникает после возвращения в работу электронного документа.
// Выполняется вне транзакции.
// 
// Параметры:
//  ЭлектронныйДокумент - ДокументСсылка.ЭлектронныйДокументВходящийЭДО
...
Процедура ПослеВозвращенияВРаботуЭлектронногоДокумента(ЭлектронныйДокумент, КонтекстДиагностики) Экспорт
	ИнтеграцияЭДО.ПослеВозвращенияВРаботуЭлектронногоДокумента(ЭлектронныйДокумент, КонтекстДиагностики);
КонецПроцедуры
...
Процедура ПослеЗагрузкиНовогоЭлектронногоДокумента(ЗагруженныйДокумент, КонтекстДиагностики) Экспорт
	...
	ВизуализацияЭДО.ПослеЗагрузкиНовогоЭлектронногоДокумента(ЗагруженныйДокумент, КонтекстДиагностики);
КонецПроцедуры
...
// 						- ДокументСсылка.ЭлектронныйДокументВходящийЭДО - ссылка на ЭлектронныйДокумент.
...
// 	КонтекстДиагностики - См. ОбработкаНеисправностейБЭД.НовыйКонтекстДиагностики.
Процедура ПослеЗагрузкиПодтвержденияПоСчетуФактуре(ЭлектронныйДокумент, ДокументыПодтверждения,
		КонтекстДиагностики) Экспорт
	
	ИнтеграцияЭДО.ПослеЗагрузкиПодтвержденияПоСчетуФактуре(ЭлектронныйДокумент, ДокументыПодтверждения,
		КонтекстДиагностики);
	ВизуализацияЭДО.ПослеЗагрузкиПодтвержденияПоСчетуФактуре(ЭлектронныйДокумент, КонтекстДиагностики);
...
// 	КонтекстДиагностики - См. ОбработкаНеисправностейБЭД.НовыйКонтекстДиагностики.
Процедура ПослеЗагрузкиИнформацииПолучателяПоАктуСверкиВзаиморасчетов(ЭлектронныйДокумент, ОписаниеДанных, 
		КонтекстДиагностики) Экспорт
	
	ИнтеграцияЭДО.ПослеЗагрузкиИнформацииПолучателяПоАктуСверкиВзаиморасчетов(ЭлектронныйДокумент, ОписаниеДанных,
		КонтекстДиагностики);

	ВизуализацияЭДО.ПослеЗагрузкиИнформацииПолучателяПоАктуСверкиВзаиморасчетов(ЭлектронныйДокумент,
		КонтекстДиагностики);
...
// 	ОписаниеДанных - См. РаботаСФайламиБЭДКлиентСервер.НовоеОписаниеФайла.
// 	КонтекстДиагностики - См. ОбработкаНеисправностейБЭД.НовыйКонтекстДиагностики.
Процедура ПослеЗагрузкиДополнительныхСведенийПоАктуОРасхождениях(ЭлектронныйДокумент, ОписаниеДанных, 
		КонтекстДиагностики) Экспорт
	
	ИнтеграцияЭДО.ПослеЗагрузкиДополнительныхСведенийПоАктуОРасхождениях(ЭлектронныйДокумент, ОписаниеДанных, 
		КонтекстДиагностики);
	ВизуализацияЭДО.ПослеЗагрузкиДополнительныхСведенийПоАктуОРасхождениях(ЭлектронныйДокумент, КонтекстДиагностики);
...
Процедура ПередУдалениемДокумента(ЭлектронныйДокумент, Отказ) Экспорт
	...
	ВизуализацияЭДО.ПередУдалениемДокумента(ЭлектронныйДокумент, Отказ);
...
Процедура ПриИзмененииДанныхОсновногоФайлаДокумента(ЭлектронныйДокумент) Экспорт
	ВизуализацияЭДО.ПриИзмененииДанныхОсновногоФайлаДокумента(ЭлектронныйДокумент);
КонецПроцедуры
