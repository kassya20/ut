...
Процедура ПодготовитьГруппуРазмещенияДепозитногоКалькулятора(ЭлементыФормы, ДополнительныеПараметры)
	...
	ИмяГруппыГоризонтальнаяПодвал = ОбменСБанкамиДепозитыСлужебныйКлиентСервер.ИмяЭлементаФормы("ГоризонтальнаяГруппаПодвал");
	...
	ИмяГруппыГоризонтальнаяОписание = ОбменСБанкамиДепозитыСлужебныйКлиентСервер.ИмяЭлементаФормы("ГоризонтальнаяГруппаОписание");
