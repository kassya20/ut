...
// Интервал начнет отсчитываться после подключения обработчиков новостей, которые в свою очередь
//  могут быть отложены с помощью ПереопределитьВремяПодключенияОбработчиковНовостейПриСтартеПрограммы.
// Первые важные и очень важные новости будут показаны после ПереопределитьВремяПодключенияОбработчиковНовостейПриСтартеПрограммы
//  и ПереопределитьВремяПервогоПоказаВажныхИОченьВажныхНовостейПриСтартеПрограммы.
//
// Параметры:
...
// Выполняет отложенное подключение обработчиков подсистемы Новости.
// Первые важные и очень важные новости будут показаны после ПереопределитьВремяПодключенияОбработчиковНовостейПриСтартеПрограммы
//  и ПереопределитьВремяПервогоПоказаВажныхИОченьВажныхНовостейПриСтартеПрограммы.
//
// Параметры:
//  ИнтервалСекунд - Число - интервал в секундах, после которого (при старте программы) будут подключены
//         обработчики показа важных и очень важных новостей. Допустимые значения: от 0 до 999.
//       Если значение = 0 (по-умолчанию), то обработчики будут подключаться сразу, без вызова "ПодключитьОбработчикОжидания".
//
//@skip-warning
