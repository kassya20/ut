...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	...
	Методы.Вставить("ЗапросВремениДоАвтоматическогоРезервногоКопирования", Истина);
	Методы.Вставить("ИнициализацияНастроекОблачногоАрхиваВФоне", Истина);
	Методы.Вставить("СохранениеНастроекОблачногоАрхиваВФоне", Истина);
