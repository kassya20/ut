...
Процедура ОбработатьТаблицуПоддерживаемыхФорматов(ТаблицаФорматов) Экспорт
	...
	ТаблицаФорматов.Свернуть("ИдентификаторЭДО, ИдентификаторФорматаВСервисе, ВариантЗаполнения");
...
Функция ПараметрыСвязиИдентификаторов(ПараметрыПолучения, КонтекстДиагностики = Неопределено,
	...
	Пока Выборка.Следующий() Цикл
		...
		Если Выборка.ВключатьВСписок
			...
			Если ФормироватьСписокВыбора И ТипЗнч(НоваяСтрока.СписокВыбора) = Тип("СписокЗначений") Тогда
				...
				ДанныеИдентификатора.Вставить("ИНН", Выборка.АбонентИНН);
				ДанныеИдентификатора.Вставить("КПП", Выборка.АбонентКПП);
				ДанныеИдентификатора.Вставить("Идентификатор", Выборка.ИдентификаторКонтрагента);
				ДанныеИдентификатора.Вставить("КраткоеОписание", Выборка.ИдентификаторКонтрагентаКраткоеОписание);
				ДанныеИдентификатора.Вставить("Оператор", Выборка.ОператорКонтрагента);
				ДанныеИдентификатора.Вставить("ПредставлениеОператора", Выборка.ОператорКонтрагентаПредставление);
				ДанныеИдентификатора.Вставить("КлючПриглашения", Выборка.КлючПриглашения);

				НоваяСтрока.ДополнительныеДанныеСпискаВыбора.Вставить(Выборка.ИдентификаторКонтрагента, ДанныеИдентификатора);
			КонецЕсли;
	...
	ТрансграничныйЭДО.ЗаполнитьПараметрыСвязиИдентификаторов(ПараметрыСвязи);
