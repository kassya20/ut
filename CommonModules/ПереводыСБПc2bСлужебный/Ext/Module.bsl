...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	...
	Методы.Вставить("ЗаполнитьИдентификаторУчастника");
...
//
// Параметры:
//  ДокументыОпераций - Массив Из ОпределяемыйТип.ДокументОперацииСБП - документы операций;
//
// Возвращаемое значение:
//  Соответствие Из КлючИЗначение - данные оплат по документам в Системе быстрых платежей:
...
//      ***НазначениеПлатежа - Строка - назначение платежа;
//      ***ДатаОперации - Дата - фактическая дата оплаты в UTC;
//  ПараметрыНастройкиОплаты - Соответствие Из КлючИЗначение - Содержит параметры настройки вида оплаты;
//
// Возвращаемое значение:
...
//  ПараметрыНастройкиОплаты - Соответствие Из КлючИЗначение  - параметры настройки оплаты.
//
