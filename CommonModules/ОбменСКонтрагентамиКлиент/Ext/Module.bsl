...
// 
// Параметры:
// 	ПараметрыОтбора - Неопределено, Структура - см. ОбменСКонтрагентамиКлиентСервер.ПараметрыОтбораТекущихДелЭДО.
//  ОповещениеОЗакрытии - Неопределено, Структура - обработчик оповещения, который будет вызван при закрытии.
//  ПараметрыОткрытия - Неопределено, Структура - 
//    см. ОбменСКонтрагентамиКлиентСервер.ПараметрыОткрытияФормыТекущиеДелаЭДО.
//
Процедура ОткрытьТекущиеДелаЭДО(ПараметрыОтбора = Неопределено, ОповещениеОЗакрытии = Неопределено,
	...
	ИнтерфейсДокументовЭДОКлиент.ОткрытьТекущиеДелаЭДО(ПараметрыЗапуска, ОповещениеОЗакрытии, ПараметрыОткрытия);
