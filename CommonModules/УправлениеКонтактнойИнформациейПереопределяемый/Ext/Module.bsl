...
Процедура ПриНачальномЗаполненииЭлементов(КодыЯзыков, Элементы, ТабличныеЧасти) Экспорт
	...
	Элемент = Элементы.Добавить();
	Элемент.ИмяПредопределенныхДанных = "СправочникТерриторииИПомещения";
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование", "ru = 'Контактная информация справочника ""Помещения и территории""'", КодыЯзыков); // @НСтр-2
	Элемент.ИмяПредопределенногоВида = "СправочникТерриторииИПомещения";
	Элемент.Используется = Истина;

	Элемент = Элементы.Добавить();
	Элемент.ИмяПредопределенныхДанных = "АдресТерриторииИПомещения";
	Элемент.Родитель = Справочники.ВидыКонтактнойИнформации.СправочникТерриторииИПомещения;
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование", "ru = 'Адрес'", КодыЯзыков); // @НСтр-2
	Элемент.ВключатьСтрануВПредставление = Истина;
	Элемент.ВидРедактирования = "Диалог";
	Элемент.ИдентификаторДляФормул = "АдресПомещения";
	Элемент.ИмяПредопределенногоВида = "АдресТерриторииИПомещения";
	Элемент.Используется = Истина;
	...
	Элемент = Элементы.Добавить();
	Элемент.ИмяПредопределенныхДанных = "ТелефонТерриторииИПомещения";
	Элемент.Родитель = Справочники.ВидыКонтактнойИнформации.СправочникТерриторииИПомещения;
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование", "ru = 'Телефон'", КодыЯзыков); // @НСтр-2
	Элемент.ВидРедактирования = "ПолеВводаИДиалог";
	Элемент.МожноИзменятьСпособРедактирования = Истина;
	Элемент.ИдентификаторДляФормул = "ТелефонПомещения";
	Элемент.ИмяПредопределенногоВида = "ТелефонТерриторииИПомещения";
	Элемент.Используется = Истина;
	Элемент.РазрешитьВводНесколькихЗначений = Ложь;
	Элемент.Тип = Перечисления.ТипыКонтактнойИнформации.Телефон;

	Элемент = Элементы.Добавить();
	Элемент.ИмяПредопределенныхДанных = "EMailТерриторииИПомещения";
	Элемент.Родитель = Справочники.ВидыКонтактнойИнформации.СправочникТерриторииИПомещения;
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование", "ru = 'Электронная почта'", КодыЯзыков); // @НСтр-2
	Элемент.ВидРедактирования = "ПолеВвода";
	Элемент.ИдентификаторДляФормул = "ЭлектроннаяПочта";
	Элемент.ИмяПредопределенногоВида = "EMailТерриторииИПомещения";
	Элемент.Используется = Истина;
	Элемент.ПроверятьКорректность = Истина;
	Элемент.Тип = Перечисления.ТипыКонтактнойИнформации.АдресЭлектроннойПочты;
КонецПроцедуры
