...
Процедура УстановитьАдресКартинки(Изображение, АдресКартинки, ПанельОтображается, УникальныйИдентификатор) Экспорт
	
	Если Не ПанельОтображается Тогда
		Возврат;
	КонецЕсли;
	...
	Попытка
		АдресКартинки = КоммерческиеПредложенияСлужебныйВызовСервера.НавигационнаяСсылкаКартинки(
			Изображение, УникальныйИдентификатор);
	Исключение
		АдресКартинки = ПоместитьВоВременноеХранилище(БиблиотекаКартинок.КоммерческоеПредложениеКартинкаСОшибкой, 
