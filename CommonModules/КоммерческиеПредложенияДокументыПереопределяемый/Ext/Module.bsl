...
Процедура ПриКопировании(ДокументОбъект) Экспорт
	...
	КоммерческиеПредложенияДокументыУТ.ПриКопировании(ДокументОбъект);
...
// Позволяет переопределить получение единицы измерения в качестве элемента по умолчанию.
// 
// Параметры:
//  ЕдиницаИзмерения - Неопределено, ОпределяемыйТип.УпаковкаНоменклатурыБЭД - Необходимо заполнить единицей измерения 
//	по умолчанию.
Процедура ПриОпределенииЕдиницыИзмеренияПоУмолчанию(ЕдиницаИзмерения) Экспорт
	
	КоммерческиеПредложенияДокументыУТ.ПриОпределенииЕдиницыИзмеренияПоУмолчанию(ЕдиницаИзмерения);
