...
//  * СсылкаНаОбъект - ОпределяемыйТип.ОснованияЭлектронныхДокументовЭДО -
//
Функция ПараметрыЗаполненияДополнительныхПолей(ОписаниеДанныхЭД, НастройкиОбмена, НастройкаЗаполнения, СсылкаНаОбъект) Экспорт
...
Функция СформироватьЗначенияДополнительныхПолейДокумента(ОбъектУчета, Настройки, Данные, ОтключитьРассчетДополнительныхПолей) Экспорт
	...
	Иначе
		...
		ПараметрыЗаполнения = ПараметрыЗаполненияДополнительныхПолей(
			ДанныеДокумента, Настройки, НастройкаЗаполнения, СсылкаНаОбъект);
