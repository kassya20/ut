...
Функция КоличествоСопоставленныхЗначений(РеквизитВидаНоменклатуры)
	...
	ТипЗначения = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(РеквизитВидаНоменклатуры, "ТипЗначения");
	Если НЕ ТипЗначения.СодержитТип(ТипДополнительныхЗначений) Тогда
		Возврат 0;
	КонецЕсли;
