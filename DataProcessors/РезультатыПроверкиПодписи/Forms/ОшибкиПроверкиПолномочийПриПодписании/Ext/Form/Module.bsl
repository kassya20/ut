...
&НаКлиенте
Процедура НадписьНастройкаСтрогостиПроверкиМЧДНажатие(Элемент)
	
	ОткрытьФорму("Обработка.РезультатыПроверкиПодписи.Форма.ИнформацияОРежимеРаботыСДоверенностями", , ЭтотОбъект, 
