...
Функция ТипыОбъектов() Экспорт
	...
	Типы.Вставить("ЯвляетсяБессрочным", АнонимныйТип("Файл.Документ.ЯвляетсяБессрочным"));
	...
	Типы.Вставить("СвойстваФайлов", АнонимныйТип("Файл.Документ.СвойстваФайлов"));
	Типы.Вставить("СвойстваФайла", АнонимныйТип("Файл.Документ.СвойстваФайлов.СвойстваФайла"));
