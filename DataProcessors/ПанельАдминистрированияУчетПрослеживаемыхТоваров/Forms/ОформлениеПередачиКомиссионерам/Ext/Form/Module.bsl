...
Процедура СоздатьДокументРеализацияТоваров(Организация, Комиссионер, Соглашение, ДокументВозврат)
	...
	СтруктураПересчетаСуммы = ПакетнаяОбработкаТабличнойЧастиКлиентСервер.ПараметрыПересчетаСуммыНДСВСтрокеТЧ(ДокументРеализация);
	...
	ПакетнаяОбработкаТабличнойЧастиСервер.ОбработатьТЧ(ДокументРеализация.Товары, СтруктураДействий);
