...
Процедура СоздатьДокументВозвратТоваров(Организация, Комиссионер, Соглашение)
	...
	СтруктураПересчетаСуммы = ПакетнаяОбработкаТабличнойЧастиКлиентСервер.ПараметрыПересчетаСуммыНДСВСтрокеТЧ(ДокументВозврат);
	...
	ПакетнаяОбработкаТабличнойЧастиСервер.ОбработатьТЧ(ДокументВозврат.Товары, СтруктураДействий);
