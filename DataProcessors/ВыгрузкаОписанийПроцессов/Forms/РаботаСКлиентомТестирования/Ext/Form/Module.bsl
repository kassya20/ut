...
Процедура ДекорацияКакПодключитьКомпонентуОбработкаНавигационнойСсылки(Элемент, НавигационнаяСсылкаФорматированнойСтроки, СтандартнаяОбработка)
	...
	Если НавигационнаяСсылкаФорматированнойСтроки = "e1cib/list/Справочник.ВнешниеКомпоненты" Тогда
		...
		ПоказатьОповещениеПользователя(,,ТекстСообщения,БиблиотекаКартинок.ЗеленаяГалкаСредняя);
...
// Получает реальную форму из тестируемого окна клиентского приложения
// 
// Параметры:
//  ТекОкно - ТестируемоеОкноКлиентскогоПриложения - Тек окно
// 
// Возвращаемое значение: 
//  ТестируемаяФорма - тестируемая форма
//  
&НаКлиенте
...
// Получает форму из тестируемого окна клиентского приложения
// 
// Параметры:
//  ТекущееОкно - ТестируемоеОкноКлиентскогоПриложения - Тек окно
// 
// Возвращаемое значение: 
//  ТестируемаяФорма - тестируемая форма
//  
...
// Определяет, является ли текущее окно модальной формой
// 
// Параметры:
//  ОкноПриложения - ТестируемоеОкноКлиентскогоПриложения - Тек окно
// 
// Возвращаемое значение: 
//  Булево - тестируемая форма
//  
&НаКлиенте
