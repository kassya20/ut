...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Для Каждого Элемент Из Параметры.КоллекцияОшибок Цикл
		...
		ИначеЕсли ЗначениеРеквизитов.ПрограммаБанка = Перечисления.ПрограммыБанка.SberAPI Тогда
				
			ПолныйАдресСервиса = ОбменСБанкамиSberAPIСлужебный.АдресSberAPIIntegration();
