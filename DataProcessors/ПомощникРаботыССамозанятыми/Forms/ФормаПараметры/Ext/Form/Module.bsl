...
Процедура КоличествоПриИзменении(Элемент)
	...
	Если ТипЗнч(СведенияПоНоменклатуре) = Тип("Структура") Тогда
		...
		ПакетнаяОбработкаТабличнойЧастиКлиент.ОбработатьСтрокуТЧ(СведенияПоНоменклатуре, СтруктураДействий, Неопределено);
...
Процедура ЗаполнитьСведенияПоНоменклатуре()
	...
	Если ТипЗнч(Номенклатура) = Тип("СправочникСсылка.Номенклатура") Тогда
		...
		ПакетнаяОбработкаТабличнойЧастиСервер.ОбработатьСтрокуТЧ(СведенияПоНоменклатуре, СтруктураДействий, Неопределено);
