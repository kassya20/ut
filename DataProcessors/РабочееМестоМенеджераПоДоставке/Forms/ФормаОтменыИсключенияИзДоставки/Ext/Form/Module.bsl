...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ШаблонЗаголовка = НСтр("ru = 'Вес, %1'");
	Элементы.СписокВес.Заголовок = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
		ШаблонЗаголовка,
		Строка(Константы.ЕдиницаИзмеренияВеса.Получить()));
		
	ШаблонЗаголовка = НСтр("ru = 'Объем, %1'");
	Элементы.СписокОбъем.Заголовок = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
		ШаблонЗаголовка,
		Строка(Константы.ЕдиницаИзмеренияОбъема.Получить()));
...
Функция ВернутьВДоставкуНаСервере()
	...
	Для Каждого ИДСтроки Из Элементы.Список.ВыделенныеСтроки Цикл // Число
