...
&НаКлиенте
Перем ВыполняетсяЗакрытие; // Булево
...
#Область ОбработчикиСобытийЭлементовТаблицыФормыТипыТранспортныхСредств
...
#Область ОбработчикиСобытийЭлементовТаблицыФормыВыбранныеТранспортныеСредства
...
Процедура ПеренестиСтроки(Знач МассивСтрок, ЭтоТранспортныеСредства = Истина)
	...
	Если МассивСтрок.Количество() = 0 Тогда
		...
		ОбщегоНазначения.СообщитьПользователю(НСтр("ru='Не выбран транспорт';"));
		Возврат;
