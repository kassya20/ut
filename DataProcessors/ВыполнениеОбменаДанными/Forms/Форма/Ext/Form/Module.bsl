...
&НаКлиенте
Процедура ЗапуститьФоновоеЗаданиеВыполнитьЗагрузкуПолученногоИзИнтернетаФайла(Действие, Отказ)
	
	ПараметрыЗадания = ИнициализироватьПараметрыЗадания(Отказ);
	
	Результат = ЗапуститьФоновоеЗаданиеВыполнитьЗагрузкуПолученногоИзИнтернетаФайлаНаСервере(ПараметрыЗадания, ОшибкаРасхожденияВерсийПриПолученииДанных, ПроверятьРасхождениеВерсий);
...
Процедура ЗавершениеДлительнойОперации()
	...
	Иначе
		...
		Если ФоновоеЗаданиеВыполняемоеДействие = 1 
			...
			ЗапуститьФоновоеЗаданиеВыполнитьЗагрузкуПолученногоИзИнтернетаФайла(ФоновоеЗаданиеВыполняемоеДействие, Ложь);
...
&НаСервере
Функция ЗапуститьФоновоеЗаданиеВыполнитьЗагрузкуПолученногоИзИнтернетаФайлаНаСервере(Знач ПараметрыЗадания, ОшибкаРасхожденияВерсийПриПолученииДанных, ПроверятьРасхождениеВерсий)
