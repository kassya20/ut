...
Процедура ИзменитьВидимостьКолонкиКоличестваСообщений()
	Элементы.ВходящиеЭлектронныеДокументыКоличествоНепрочитанныхСообщений.Видимость = ВыполненПереходНаУниверсальныеСообщения;
	Элементы.ИсходящиеЭлектронныеДокументыКоличествоНепрочитанныхСообщений.Видимость = ВыполненПереходНаУниверсальныеСообщения;
КонецПроцедуры
