...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.ФормаУстановитьАктуальныйДокументооборот.Доступность = ЕстьПравоОбработкиЭД;
	Элементы.ФормаОбработкаЭлектронныеДокументыОтправитьИПолучитьЭД.Доступность = ЕстьПравоОбработкиЭД;
