...
Процедура ЗагрузитьРезультатПолученияСпискаПеревозчиков(Результат)
	...
	Для Каждого ТекущийЭлементСписка Из Результат.Список Цикл
		...
		ЗаполнитьЗначенияСвойств(СтрокаТаблицы, ТекущийЭлементСписка);
...
Процедура ЗаполнитьИнформациюПоАвторизации(СтрокаТаблицы)
	...
	ИначеЕсли СтрокаТаблицы.ВозможнаРаботаБезАвторизации И СтрокаТаблицы.ТребуетсяАвторизация Тогда
