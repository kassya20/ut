...
Процедура УстановитьВидимостьЛокализация()
	...
	Элементы.ЗагрузитьОплатыИзЯндексКассы.Видимость = Не ЭтоБазоваяВерсия И ЕстьПравоЗагрузкиОплатИзЯндексКассы;
	// Конец ЭлектронноеВзаимодействие.ИнтеграцияСЯндексКассой
	...
	Элементы.ЗагрузитьОплаченныеСсылкиСБП.Видимость = Не ЭтоБазоваяВерсия И ЕстьПравоЗагрузкиОплатИзСБП;
	
	ЕстьПравоЗагрузкиОплатОнлайнЗаказов = ОнлайнЗаказы.ОнлайнЗаказыДоступны()
		Или Пользователи.ЭтоПолноправныйПользователь();
	Элементы.ЗагрузитьОплаченныеСсылкиОнлайнЗаказов.Видимость = Не ЭтоБазоваяВерсия И ЕстьПравоЗагрузкиОплатОнлайнЗаказов;
