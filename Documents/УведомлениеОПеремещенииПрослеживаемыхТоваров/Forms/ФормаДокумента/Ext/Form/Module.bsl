...
&НаКлиенте
Процедура ТоварыРНПТПриИзменении(Элемент)
	
	ТекущиеДанные = Элементы.Товары.ТекущиеДанные;
	
	Если ТекущиеДанные <> Неопределено Тогда
		ЕдиницаПрослеживаемости = ЕдиницапрослеживаемостиПоРНПТ(ТекущиеДанные.РНПТ);
		Если ЗначениеЗаполнено(ЕдиницаПрослеживаемости) Тогда
			ТекущиеДанные.ЕдиницаПрослеживаемости = ЕдиницаПрослеживаемости;
		КонецЕсли;
	КонецЕсли;
...
Функция ЕдиницапрослеживаемостиПоРНПТ(РНПТ)
	
	Возврат ПрослеживаемостьПереопределяемый.ЕдиницапрослеживаемостиПоРНПТ(РНПТ);
