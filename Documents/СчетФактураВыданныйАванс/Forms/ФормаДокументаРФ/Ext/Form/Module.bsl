...
КонецПроцедуры
// Конец ИнтернетПоддержкаПользователей.РаботаСКонтрагента
...
Процедура УказатьИсходныйСчетФактуруВАвансах(ВыбранныйСчетФактура, МассивСтрок)
	...
	Иначе
		...
		СтавкаНДС = УчетНДСУП.СтавкаНДСПоУмолчанию(Объект.Организация, ДатаОснования, Истина);
	КонецЕсли;
	...
	Для Каждого ИдентификаторСтроки Из МассивСтрок Цикл
		...
		СтрокаАванса.СтавкаНДС = СтавкаНДС;
