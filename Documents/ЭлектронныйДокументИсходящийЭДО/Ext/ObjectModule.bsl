...
Процедура ПередЗаписью(Отказ, РежимЗаписи, РежимПроведения)
	...
	Если ПустаяСтрока(ИдентификаторДокумента) Тогда
		ИдентификаторДокумента = ЭлектронныеДокументыЭДОКлиентСервер.НовыйИдентификаторДокумента();
	КонецЕсли;
...
Процедура ПередУдалением(Отказ)
	...
	ЭлектронныеДокументыЭДО.ПередУдалениемДокумента(ЭтотОбъект, Отказ);
