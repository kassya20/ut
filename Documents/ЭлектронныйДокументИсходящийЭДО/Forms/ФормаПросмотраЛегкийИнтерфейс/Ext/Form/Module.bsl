...
Процедура ОбновитьДанныеДляПросмотраДокумента()
	...
	ДанныеКомпонентов = ЛегкийИнтерфейсДокументовЭДО.НовыеДанныеКомпонентовПросмотраДокумента(
		...
		|ПанельМаршрута, ПанельСопроводительнойЗапискиИсходящегоДокумента, ПанельРеквизитов, ПанельРеквизитовПакета, ПанельСообщений");
...
#Область ЗаполнениеПодготовленныхЦентраЭДО
...
Процедура ЗаполнитьДанныеДокументаПриИзмененииКлючевыхРеквизитов()
	...
	ИспользоватьЦентрЭДО = Ложь;
	Если ЗначениеЗаполнено(НастройкиОтправки) Тогда
		ИспользоватьЦентрЭДО = 
			УчетныеЗаписиЭДО.ИспользоватьЦентрЭДО(НастройкиОтправки.ИдентификаторОтправителя);
	КонецЕсли;
