...
Процедура ПриОткрытии(Отказ)
	...
	Иначе
		...
		ПодключаемоеОборудованиеПараметры = МенеджерОборудованияКлиент.ПодключаемоеОборудование().ПараметрыПодключенияПО; // Массив из см. Справочники.ПодключаемоеОборудование.ДанныеУстройства
