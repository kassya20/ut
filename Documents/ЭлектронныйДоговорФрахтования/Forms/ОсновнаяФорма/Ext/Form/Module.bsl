	...
	Если Объект.ЭтоВходящий = Истина Тогда	
		...
		Иначе
			...
			ОбменСГИСЭПДКлиентСервер.УстановитьЗначениеРеквизитаВСтруктуреФормы(ЭтотОбъект, 
				"ТитулФрахтовщикаНаименованиеЭкономическогоСубъекта", , , , Истина);
		КонецЕсли;
	КонецЕсли;
...
Процедура СсылкаТитулФрахтовщикаСоставительПриИзменении(Элемент)
	...
	Если ЗначениеЗаполнено(Объект.СсылкаТитулФрахтовщикаСоставитель) Тогда
		...
		ОбменСГИСЭПДКлиентСервер.УстановитьЗначениеРеквизитаВСтруктуреФормы(ЭтотОбъект, 
			"ТитулФрахтовщикаНаименованиеЭкономическогоСубъекта", РеквизитыСоставителя.НаименованиеПолное, , , Истина);
	Иначе
		ОбменСГИСЭПДКлиентСервер.УстановитьЗначениеРеквизитаВСтруктуреФормы(ЭтотОбъект, 
			"ТитулФрахтовщикаНаименованиеЭкономическогоСубъекта", , , , Истина);	
	КонецЕсли;
...
Процедура ВариантЗаФрахтователяПоДоверенностиПриИзмененииСервер()
	...
	Если Объект.ЭтоВходящий = Ложь Тогда	
		...
		Иначе
			...
			ОбменСГИСЭПДКлиентСервер.УстановитьЗначениеРеквизитаВСтруктуреФормы(ЭтотОбъект, 
				"ТитулФрахтователяНаименованиеСубъекта", , , , Истина);
		КонецЕсли;
	КонецЕсли;
...
Процедура СсылкаТитулФрахтователяСоставительПриИзменении(Элемент)
	...
	Если ЗначениеЗаполнено(Объект.СсылкаТитулФрахтователяСоставитель) Тогда
		...
		ОбменСГИСЭПДКлиентСервер.УстановитьЗначениеРеквизитаВСтруктуреФормы(ЭтотОбъект, 
			"ТитулФрахтователяНаименованиеСубъекта", РеквизитыСоставителя.НаименованиеПолное, , , Истина);
	Иначе
		ОбменСГИСЭПДКлиентСервер.УстановитьЗначениеРеквизитаВСтруктуреФормы(ЭтотОбъект, 
			"ТитулФрахтователяНаименованиеСубъекта", , , , Истина);	
	КонецЕсли;
