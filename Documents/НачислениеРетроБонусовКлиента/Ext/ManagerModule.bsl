...
//  * Ссылка - ДокументСсылка.НачислениеРетроБонусовКлиента
//  * Номер - Строка -
//  * Дата - Дата
...
Процедура ОбработкаПолученияПредставления(Данные, Представление, СтандартнаяОбработка)
	...
	Если НЕ ПолучитьФункциональнуюОпцию("ВыводитьПолныеНаименованияРетроБонусовКлиентов") Тогда
		Возврат;
	КонецЕсли;
...
Функция ШаблонЗаголовкаДокумента() Экспорт
	...
	Если ПолучитьФункциональнуюОпцию("ВыводитьПолныеНаименованияРетроБонусовКлиентов") Тогда
		...
		ШаблонЗаголовкаДокумента = НСтр("ru = 'Начисление ретро-бонусов клиента %1'");
		
	Иначе
		
		ШаблонЗаголовкаДокумента = НСтр("ru = 'Начисление РБ клиента %1'");
