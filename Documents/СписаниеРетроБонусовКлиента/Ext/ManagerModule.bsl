...
//  * Ссылка - ДокументСсылка.СписаниеРетроБонусовКлиента
//  * Номер - Строка -
//  * Дата - Дата
...
Функция ШаблонЗаголовкаДокумента() Экспорт
	...
	Если ПолучитьФункциональнуюОпцию("ВыводитьПолныеНаименованияРетроБонусовКлиентов") Тогда
		...
		ШаблонЗаголовкаДокумента = НСтр("ru = 'Списание ретро-бонусов клиента %1'");
		
	Иначе
		
		ШаблонЗаголовкаДокумента = НСтр("ru = 'Списание РБ клиента %1'");
