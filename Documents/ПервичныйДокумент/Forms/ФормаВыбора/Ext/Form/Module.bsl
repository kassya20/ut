...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Отбор.Свойство("НалогообложениеНДС", ПараметрНалогообложениеНДС) Тогда
		...
		ВидСравненияНалогообложениеНДС = ВидСравненияКомпоновкиданных.Равно;
		Если ТипЗнч(НалогообложениеНДС) = Тип("СписокЗначений") Тогда
			ВидСравненияНалогообложениеНДС = ВидСравненияКомпоновкиданных.ВСписке;
		КонецЕсли;
		...
		ОтборыСписковКлиентСервер.ИзменитьЭлементОтбораСписка(
			...
			ВидСравненияНалогообложениеНДС);
