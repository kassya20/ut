...
Процедура ЗаполнитьТаблицуТоваров()
	...
	Если Не ВозвратОтРозничногоПокупателя
		...
		|	ТаблицаПроверяемыеТовары.Склад КАК Склад,
		...
		|	ТаблицаПроверяемыеТовары.Склад,
	...
	Для каждого Строка Из ТаблицаТоваровВыгрузка Цикл
		...
		СоответствиеСтрок.Вставить(НоваяСтрока, Строка);
	...
	Для каждого НоваяСтрока Из ОбрабатываемыеСтроки Цикл
		...
		Строка = СоответствиеСтрок.Получить(НоваяСтрока);
